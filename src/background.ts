...
async function gitpodifyCurrentTab() {
    try {
        ...
        try {
            ...
            window.open("https://cloud.sealos.io/");
        }
    }
}
...
browser.runtime.onInstalled.addListener((details) => {
    if (details.reason === "install") {
        window.open("https://www.cloud.sealos.io/extension-activation?track=true");
    }
});
browser.runtime.setUninstallURL("https://www.cloud.sealos.io/extension-uninstall?track=true");
